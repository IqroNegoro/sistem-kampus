...
<script setup>
import Rows from "@/components/admin/lecturer/Rows.vue";
import Add from "@/components/admin/lecturer/Add.vue";
import Edit from "@/components/admin/lecturer/Edit.vue";
import Info from "@/components/admin/lecturer/Info.vue";
