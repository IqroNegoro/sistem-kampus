...
<script setup>
import Rows from "@/components/admin/schedule/Rows.vue";
import Add from "@/components/admin/schedule/Add.vue";
import Edit from "@/components/admin/schedule/Edit.vue";
