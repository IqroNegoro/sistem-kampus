...
<script setup>
import Rows from "@/components/admin/building/Rows.vue";
import Add from "@/components/admin/building/Add.vue";
import Edit from "@/components/admin/building/Edit.vue";
